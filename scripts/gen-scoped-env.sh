...
grep -E '^(DISCORD_TOKEN|DISCORD_GUILD_ID|DISCORD_ADMIN_ROLE_ID|DISCORD_REMOVER_ROLE_ID|DISCORD_NOTIFY_CHANNEL_ID|DOCKER_API_URL|RCON_ADDR|RCON_PASSWORD|SERVER_ADDRESS|TZ)=' "$ENV_FILE" > "$DIR/.env.bot"
